...
function ContentLoginRegister({ setEmailogin, setPasswordlogin, setEmail,
    ...
    notificationRegister, notificationLogin, registerSubmit, loginSubmit }){
        ...
        if(Login){
            ...
            >Login</button>
            <button
                className="btn btn-default" style={{background: '#166FE5'}}
            ><a href='https://www.facebook.com/' target='_blank' style={{color: 'white'}} >Login by Facebook</a></button>
             <button
                className="btn btn-default" style={{background: '#CD352A'}}
            ><a href='https://accounts.google.com/' target='_blank' style={{color: 'white'}}>Login by Gmail</a></button>
